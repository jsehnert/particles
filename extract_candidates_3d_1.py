...
def _eigen_features_with_axes(
    ...
    l1, l2, l3: Sheppard-corrected eigenvalues, large → small. The shape triple is
        (linearity, planarity, sphericity) = ((l1-l2)/l1, (l2-l3)/l1, l3/l1).
...
def detect_candidates_streaming(
    ...
    for r0, r1, c0, c1 in iter_slabs(Z, slices_per_chunk, halo):
        ...
        for i, lid in enumerate(ids):
            ...
            # More features extracted from the eigevalues
