...
from apps.vol_analysis import (  # noqa: E402
    _CANDIDATE_FIELDS,
    HISTORICAL_MIN_FILL,
    GlobalData,
    ...
    try:
        for _, experiment in exp_matches:
            ...
            experiment_params = _experiment_param_values(
                experiment, HISTORICAL_MIN_FILL
            )
...
def main(
    ...
    for st in slab_thickness:
        for c in cell:
            run_cell_slab(
                cfg, c, st, aniso_factor, run_parallel, n_workers, force=force
            )
