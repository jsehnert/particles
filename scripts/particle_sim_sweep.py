...
Inspect the default production configuration without allocating volumes::
    ...
    python scripts/particle_sim_sweep.py --dry-run

Run a small uint8 pilot::

    python scripts/particle_sim_sweep.py \
...
# Make direct execution (``python scripts/particle_sim_sweep.py``) resolve the
